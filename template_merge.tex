...
\begin{table}[H]
\centering
\caption{四个子问题的数学模型汇总}
\label{tab:model-summary}
\begin{tabular}{p{1.5cm}p{3.3cm}p{2.8cm}p{3.3cm}p{3.4cm}}
\toprule
问题 & 控制方程 & 物性来源 & 关键修正 & 核心公式编号\\
\midrule
1 & 温度方程 + 水分方程（解耦） & 附录 2 & 常物性、传热传质互不影响 & 见 5.1 节控制方程\\
2 & 温度方程 + 水分方程（双向耦合） & 附录 3 & 变物性双向耦合、环境条件常数外推 & 见 5.2 节控制方程\\
3 & 同问题二 & 附录 3 & 全域最大值判据 $C_{\max}(t)$ & 见 5.3 节判据式\\
4 & 材料坐标下的温度/水分方程 & 附录 4 & 材料坐标变换 + 移动边界修正 & 见 5.4 节坐标变换\\
\bottomrule
\end{tabular}
\end{table}
